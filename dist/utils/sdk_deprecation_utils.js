...
function migrateDeprecatedEventKeys(embedOptions) {
    ...
    Object.keys(exports.deprecatedEventMap).forEach((oldKey) => {
        const newKey = exports.deprecatedEventMap[oldKey];
        if (!newKey)
            return;
...
function checkDeprecatedEmbedOptions(options) {
    Object.keys(exports.deprecatedMemberMap).forEach((oldKey) => {
        ...
        if (found) {
            console.warn(`[Deprecation Warning] '${oldKey}' is deprecated. Please use '${exports.deprecatedMemberMap[oldKey]}' instead.`);
        }
    });
}
function deprecatedMethod(methodName) {
    if (deprecatedMethodMap[methodName]) {
        console.warn(`[Deprecation Warning] '${methodName}()' is deprecated. Please use '${deprecatedMethodMap[methodName]}()' instead.`);
    }
}
